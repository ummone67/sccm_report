...
SELECT DISTINCT 
 ...
 v_GS_PROCESSOR.Name0 'CPU Model', ---by Ummone67
...
FROM
 ...
 INNER JOIN v_GS_PROCESSOR ON SYS.ResourceID = v_GS_PROCESSOR.ResourceID  ---by Ummone67
 ...
 SYS.ResourceID ,
 SYS.AD_Site_Name0 ,
 v_GS_PROCESSOR.Name0, ---by Ummone67
 CS.UserName0 ,
